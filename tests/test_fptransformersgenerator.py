...
from scikit_mol.fingerprints import (MorganFPGeneratorTransformer,
                                     RDKitFPGeneratorTransformer,
                                     AtomPairFPGeneratorTransformer,
                                     TopologicalTorsionFPGeneatorTransformer,
                                     )

test_transformers = [MorganFPGeneratorTransformer, RDKitFPGeneratorTransformer,
                     AtomPairFPGeneratorTransformer, TopologicalTorsionFPGeneatorTransformer]
...
def test_morgan_set_params(chiral_mols_list):
    ...
    assert_transformer_set_params(MorganFPGeneratorTransformer, new_params, chiral_mols_list)
...
def test_atompairs_set_params(chiral_mols_list):
    ...
    assert_transformer_set_params(AtomPairFPGeneratorTransformer, new_params, chiral_mols_list)
...
def test_topologicaltorsion_set_params(chiral_mols_list):
    ...
    assert_transformer_set_params(TopologicalTorsionFPGeneatorTransformer, new_params, chiral_mols_list)
...
def test_RDKitFPTransformer(chiral_mols_list):
    ...
    assert_transformer_set_params(RDKitFPGeneratorTransformer, new_params, chiral_mols_list)
